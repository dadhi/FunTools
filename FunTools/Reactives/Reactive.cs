...
namespace FunTools.Reactives
{
	public static class Reactive
	{
		...
		public static Reactive<T> Of<T>()
		{
			return new ValueReactive<T>(default(T));
		}

		public static Reactive<T> Of<T>(T value)
		{
			return new ValueReactive<T>(value);
		}
		...
		public static Reactive<T> OfLazy<T>(Func<T> initializer)
		{
			return new LazyValueReactive<T>(initializer);
		}
		...
		{
		    var getProperty = property.ThrowIfNull().Compile();
            var reactive = new ValueReactive<TProperty>(getProperty(model.ThrowIfNull()));
